...
This presentation is done for the JHU Data Science Coursera course Developing Data Products. The final assignment was to create a Shiny app and a reproducible pitch

Access the shiny app [here](https://kgafrifa.shinyapps.io/ShinyApp/)

Access the github repo that hosts the files [here](https://github.com/kgafrifa/JHU_Developing-Data-Products-Week-4-Course-Project/tree/main/COVID-19_Dashboard)
